        ...
        <div className="grid grid-cols-1 gap-10">
          ...
          <div className="space-y-1">
            ...
            <div className="flex justify-center pt-2">
              {/* Calender */}
              <DateRange rangeColors={['#F6536D']} editableDateInputs={true} onChange={(item) => handleDates(item)} moveRangeOnFirstSelection={false} ranges={[dates]} />
            </div>
          </div>
          ...
          <div className="space-y-1 text-sm">
            ...
            <textarea
              ...
              onChange={(e) => setRoomData({ ...roomData, description: e.target.value })}></textarea>
          </div>
        </div>
